...
class MicrosoftGraphConnector:
    ...
    def fetch(self):
        ...
        devices_url = "https://graph.microsoft.com/v1.0/deviceManagement/managedDevices?$top=80&$select=deviceName,operatingSystem,complianceState,lastSyncDateTime,azureADDeviceId"
        alerts_url = "https://graph.microsoft.com/v1.0/security/alerts_v2?$top=25&$orderby=createdDateTime desc"
        ...
        noncompliant = [d for d in devices if str(d.get("complianceState", "")).lower() not in ("compliant", "unknown")]
